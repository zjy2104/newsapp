...
class NewsListWidget1 extends StatefulWidget {
  NewsListWidget1():super();


  _NewsListState createState() => _NewsListState(user:fetchPost(1));
}

class _NewsListState extends State<NewsListWidget1>
