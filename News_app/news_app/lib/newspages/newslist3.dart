...
class NewsListWidget3 extends StatefulWidget {
  NewsListWidget3():super();


  _NewsListState createState() => _NewsListState(user:fetchPost(3));
}

class _NewsListState extends State<NewsListWidget3>
